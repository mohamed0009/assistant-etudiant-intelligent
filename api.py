"""
Enhanced API for Professional RAG System
Integrates all improvements for production-ready performance.
"""
...
# Enhanced imports
from src.rag_engine import ProfessionalRAGEngine, create_professional_rag_engine
...
class EnhancedQuestionRequest(BaseModel):
    ...
    model_preference: Optional[str] = Field(None, description="auto, ollama, huggingface")
